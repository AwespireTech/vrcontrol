...
// ConnectDevice 連接設備
// @Router /api/devices/:id/connect [post]
...
// @Router /api/devices/:id/disconnect [post]
...
// @Router /api/devices/usb/tcpip/enable [post]
...
// @Router /api/devices/batch/auto-reconnect [post]
...
// @Router /api/devices/:id/auto-reconnect/reset [post]
...
// @Router /api/devices/batch/auto-reconnect/reset [post]
...
// @Router /api/devices/:id/status [get]
...
// PingDevice Ping 設備
// @Router /api/devices/:id/ping [post]
...
// ConnectBatch 批量連接設備
// @Router /api/devices/batch/connect [post]
...
// @Router /api/devices/batch/status [post]
...
// @Router /api/devices/batch/ping [post]
