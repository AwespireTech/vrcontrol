...
>
> 若 `scrcpy` 未安裝，會導致鏡像相關 API（`/api/quest/scrcpy/*`）無法使用。
...
前端管理介面：`http://localhost:5173/quest`
...
- 玩家連線：`http://localhost:8080/ws/client/<player_id>`
- 房間控制：`http://localhost:8080/ws/control/<roomId>`
